...
const testimonials = [
  {
    name: "Rahul Sharma",
    role: "Pet Parent",
    text: "Got my golden lab 'Bruno' from Variety Kennel. The quality is exceptional and the guidance provided by Rakesh ji was very helpful.",
    rating: 5
  },
  {
    name: "Priya Singh",
  ...
  },
  {
    name: "Amit Verma",
    role: "Happy Customer",
    text: "Best kennel in Karnal. The environment is clean and the dogs are well cared for. My puppy is now 1 year old and very healthy.",
    rating: 5
  }
];
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {testimonials.map((t, index) => (
            <motion.div
              ...
              className="p-8 bg-bg rounded-4xl shadow-soft relative"
            >
