            ...
            <div className="max-w-7xl mx-auto px-6">
                <div className="grid md:grid-cols-4 gap-12 mb-16">
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            <li className="text-primary/60">Karnal, Haryana, India</li>
                            <li className="text-primary/60 font-bold">92153 31016</li>
                            <li className="text-primary/60">hello@varietykennel.com</li>
                        </ul>
                    </div>
                </div>
                ...
                <div className="pt-8 border-t border-accent/30 flex flex-col md:flex-row  justify-between items-center gap-4">
                    <p className="text-primary/50 text-sm">
                        © {new Date().getFullYear()} Variety Kennel. All rights reserved.
                    </p>
