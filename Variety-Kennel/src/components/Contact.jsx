...
export default function Contact() {
  ...
  const handleSubmit = (e) => {
    ...
    window.open(`https://wa.me/+919215331016?text=${text}`, '_blank');
  };
            ...
            <div className="space-y-8">
              <div className="flex items-center gap-4 group cursor-pointer">
                ...
                <div>
                  ...
                  <p className="text-xl font-bold">+91 92153 31016</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4 group cursor-pointer">
                ...
                <div>
                  ...
                  <p className="text-xl font-bold">92153 31016</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4 group cursor-pointer">
                ...
                <div>
                  ...
                  <p className="text-xl font-bold">Karnal, Haryana</p>
                </div>
              </div>
            </div>
