      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="absolute -bottom-10 -right-10 bg-secondary p-8 rounded-2xl shadow-xl z-20 max-w-[200px]">
          ...
          >
            ...
            <p className="text-lg text-primary/70 mb-8 leading-relaxed">
              At Harish Tinku Dog Kennel, we don't just breed dogs; we nurture family members. Located in the heart of Kurukashatra, our kennel is built on a foundation of love, ethical practices, and a deep understanding of various dog breeds.
            </p>
